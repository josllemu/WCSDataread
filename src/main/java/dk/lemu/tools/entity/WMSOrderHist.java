...
@NamedQueries({
    @NamedQuery(name = "WMSOrderHist.findByOrderId", query = "SELECT object(o) FROM WMSOrderHist o WHERE o.orderId = :order_Id"),
    @NamedQuery(name = "WMSOrderHist.findByOrderNumber", query = "SELECT object(o) FROM WMSOrderHist o WHERE o.orderNumber = :order_Number"),
    @NamedQuery(name = "WMSOrderHist.findByDelNoteId", query = "SELECT object(o) FROM WMSOrderHist o WHERE o.delNoteId = :delNoteId"),
    @NamedQuery(name = "WMSOrderHist.findByOrderIdOrderNumberAndDelNotId", query = "SELECT object(o) FROM WMSOrderHist o " +
        "WHERE o.orderId = :order_Id AND o.orderNumber = :order_Number AND o.delNoteId = :delNoteId")

})
@Entity
@Table(name = "WMSOrderHist",
    indexes = {
        @Index(columnList = "id"),
...
public class WMSOrderHist extends AbstractEntity implements Serializable {
  ...
  public WMSOrderHist(List<String> list) throws Exception {
