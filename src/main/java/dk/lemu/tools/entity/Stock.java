...
public class Stock extends AbstractEntity implements Serializable {
  ...
  @Column(name = "container", nullable = false, length = 25)
  ...
  @Column(name = "batchRef", length = 50)
  ...
  @Column(name = "receiptRef", length = 50)
  ...
  @Column(name = "receiptLine", length = 20)
  ...
  @Column(name = "originalItemConf", length = 50)
  ...
  @Column(name = "countryOfManfactr", length = 50)
