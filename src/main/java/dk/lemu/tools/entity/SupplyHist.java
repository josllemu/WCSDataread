...
@NamedQueries({
    @NamedQuery(name = "SupplyHist.findByOrder", query = "SELECT object(o) FROM SupplyHist o WHERE o.orderId = :orderId")
})
@Entity
@Table(name = "SupplyHist",
    indexes = {
        @Index(columnList = "id"),
        @Index(columnList = "orderId"),
        @Index(columnList = "id, orderId")})
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class SupplyHist extends AbstractEntity implements Serializable {
  ...
  public SupplyHist(List<String> list) throws Exception {
