...
public class MHEInfo extends AbstractEntity implements Serializable {
  ...
  @Column(name = "unit", unique = true, nullable = false, length = 50)
  ...
  @Column(name = "dualOnly", length = 10)
